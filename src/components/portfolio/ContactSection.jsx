            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <Textarea
                  ...
                  required
                  rows={6}
                  className="bg-white/5 border-white/10 text-white placeholder-slate-400 focus:border-blue-500 focus:bg-white/10 transition-all duration-300 resize-none"
                />
              </div>
              <Button
                type="submit"
